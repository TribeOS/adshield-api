...
<p>
	<a style="background: #28a745;color: #fff;padding: 10px 15px;border-radius: 5px;" href=
	"https://adshield.tribeos.io/password?reset={{$user->resetHash }}">Reset My Password</a>
</p>