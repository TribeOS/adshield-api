...
class KnownViolatorToolController extends BaseController
{
	...
	public function getGraphData()
	{
		...
		$data = [
			...
			'24.107.198.190' =>  generateData('24.107.198.190', [23]),
			'69.76.60.76' =>  generateData('69.76.60.76', [99]),
			'50.37.77.29' =>  generateData('50.37.77.29', [34]),
			...
			'68.13.116.36' =>  generateData('68.13.116.36', [92]),
